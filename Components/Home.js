...
const Home = ({ route, navigation }) => {
  ...
  const fetchFirmData = async (searchname) => {
    if (!searchname) {
      return;
    }
    ...
    try {
      const response = await fetch(
        `https://signpostphonebook.in/client_fetch_byname_and_byperson.php?searchname=${encodeURIComponent(
          searchname
        )}`
      );
  ...
  const fetchProductData = async (name) => {
    ...
    try {
      const response = await fetch(
        `https://signpostphonebook.in/try_product.php?product=${name}`
      );
                  ...
                  <View style={styles.rightSection}>
                    ...
                    <View style={styles.buttonContainer}>
                      ...
                      <TouchableOpacity
                        ...
                        onPress={() =>
                          Linking.openURL(`https://wa.me/${item.mobileno}`)
                        }
                      >
                        <Ionicons
                          name="logo-whatsapp"
                    ...
                    <View style={styles.innerCard}>
                      ...
                      <Text style={styles.productName}>{item.product}</Text>
                      <Text style={styles.firmName}>{item.address}</Text>
                    </View>
                    ...
                    <View style={styles.innerCard2}>
                      ...
                      <Text style={styles.productName}>{item.product}</Text>
                      <Text style={styles.firmName}>{item.adress}</Text>
                    </View>
                    {/* colored card-3 */}
